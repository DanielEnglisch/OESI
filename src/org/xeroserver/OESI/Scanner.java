...
public class Scanner {
	...
	static {
		...
		literals.put("if", new Integer(4));
		literals.put("es", new Integer(5));
		literals.put("gibt", new Integer(6));
		literals.put("is", new Integer(8));
		literals.put("blus", new Integer(20));
		literals.put("minus", new Integer(21));
		literals.put("moi", new Integer(22));
		literals.put("duach", new Integer(23));
