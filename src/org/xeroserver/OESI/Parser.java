...
//--End Editor
	...
	Node  EXPRESSION() {
		...
		while (la.kind == 20 || la.kind == 21) {
			Type operator = ADDOP();
			Node trm2 = TERM();
			exp = new Node(operator, trm1, trm2); trm1 = exp; 
		}
		return exp;
	}
	...
	Node  TERM() {
		...
		while (la.kind == 22 || la.kind == 23) {
			Type operator = MULOP();
			Node fac2 = FACTOR();
			trm = new Node(operator, fac1, fac2); fac1 = trm; 
		}
		return trm;
	}
...
class Errors {
	...
	public void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 5: s = "\"es\" expected"; break;
			case 6: s = "\"gibt\" expected"; break;
			case 7: s = "\";\" expected"; break;
			case 8: s = "\"is\" expected"; break;
